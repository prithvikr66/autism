  ...
  return (
    <div className="w-full mt-[20px]">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px] px-4">
        ...
        {publicKey && (
          <div className="w-full">
            <div className="relative w-full z-30" style={{ zIndex: 30 }}>
              <div className="absolute top-[5px] left-[5px] rounded-[4px] border-[2px] border-transparent w-full h-full bg-black" style={{ zIndex: -1 }}></div>
              <div className="relative rounded-[4px] border-black border-[2px] bg-white text-black p-[20px] flex items-center justify-between">
                ...
                <motion.button
                  ...
                  onClick={() => navigate(`/profile/edit/${publicKey.toString()}`)}
                >
                  <EditSVG />
                </motion.button>
              </div>
        ...
        <div className="w-full">
          <div className="relative w-full rounded-[4px] bg-[#4EAB5E] p-[3px]">
            <div className="absolute top-[5px] left-[5px] rounded-[4px] border-transparent w-full h-full bg-[#4EAB5E]" style={{ zIndex: -1 }}></div>
      ...
      <div className="mt-[20px] md:hidden">
        {!publicKey ? <ConnectButton>Connect & Ape</ConnectButton> : <DisconnectButton />}
      </div>
    </div>
  );
};
